...
- Keeps near at hand a list of tricks for overcoming writer's block.
...
- Uses software tools like *Grammarly*, the *LanguageTool*, and the *Hemingway.app* to stimulate improvements in their writing. Knows enough about good writing to accept only useful suggestions. For example, do not blindly accept autosuggested noun clusters.
- Uses copilot when exhausted to autocomplete sentences.
...
- Avoids prompted autogenerated text from the chatbots because the text often requires massive rewriting. 
